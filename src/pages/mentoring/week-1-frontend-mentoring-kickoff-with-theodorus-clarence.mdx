...
import localImage from '../../assets/frontend-mentoring-1st-meeting.png';
...
<Image src={localImage} alt="first frontend mentoring meeting zoom screenshot" class="w-2/3 mx-auto my-12" />
